...
// Logo rendered as text — swap for <img> if hosting the real logo
const LogoMark = () => (
  <span style={{ fontFamily: 'Playfair Display, serif', fontWeight: 700, color: 'white', fontSize: '1.5rem' }}>
    Hope's <span style={{ color: '#F0A500' }}>Horizon</span>
  </span>
);
