...
// Logo rendered as text — swap for <img> if hosting the real logo file
const FooterLogo = () => (
  <div style={{ fontFamily: 'Playfair Display, serif', fontWeight: 700, fontSize: '1.5rem', lineHeight: 1.2 }}>
    <span style={{ color: 'white' }}>Hope's </span>
    <span style={{ color: '#2B7A3E' }}>Horizon</span>
    <div style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400, fontSize: '0.65rem', color: 'rgba(255,255,255,0.4)', letterSpacing: '0.15em', textTransform: 'uppercase', marginTop: '2px' }}>
